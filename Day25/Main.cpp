...
int main()
{
	...
	vector<string> instr;
 	...
 	instr.push_back("south");
	instr.push_back("west");
	instr.push_back("take hologram");
	instr.push_back("south");
	instr.push_back("west");
	instr.push_back("west");
	instr.push_back("take hypercube");
	instr.push_back("east");
	instr.push_back("east");
	instr.push_back("north");
	instr.push_back("east");
	instr.push_back("south");
	instr.push_back("take cake");
	instr.push_back("west");
	instr.push_back("north");
	instr.push_back("take coin");
	instr.push_back("south");
	instr.push_back("east");
	instr.push_back("north");
	instr.push_back("south");
